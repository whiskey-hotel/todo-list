...
function newProject(obj) {
	obj = _storage__WEBPACK_IMPORTED_MODULE_3__.pageState.getStorage(obj.key);
...
function newTask(obj) {
	...
	newTaskCheckMark.addEventListener("click", function () {
		...
		if (complete) {
			...
			(0,_objectFactory__WEBPACK_IMPORTED_MODULE_6__.projects)().updateNumberOfTasks(obj.projectKey, "dec");
			(0,_taskCountTracking__WEBPACK_IMPORTED_MODULE_5__.updateDOMForTotalCompletedTasks)();
			(0,_taskCountTracking__WEBPACK_IMPORTED_MODULE_5__.updateDOMForCompletedTask)(obj.projectKey);
			!(0,_objectFactory__WEBPACK_IMPORTED_MODULE_6__.projects)().getCompletedStatus() ? timer1() : null;
		} else {
			newTaskCheckMark.checked = false;
			(0,_objectFactory__WEBPACK_IMPORTED_MODULE_6__.projects)().updateNumberOfTasks(obj.projectKey);
			(0,_taskCountTracking__WEBPACK_IMPORTED_MODULE_5__.updateDOMForTotalCompletedTasks)("dec");
			(0,_taskCountTracking__WEBPACK_IMPORTED_MODULE_5__.updateDOMForCompletedTask)(obj.projectKey, "inc");
			clearTimeout(timer1);
		}
	});
...
function removeProject(storageKey) {
	...
	(0,_objectFactory__WEBPACK_IMPORTED_MODULE_1__.projects)().changeCurrentProject("P0");
}
