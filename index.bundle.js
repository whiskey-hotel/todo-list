...
function home(mainObj) {
	...
	const completedTasks = (0,_DOMController__WEBPACK_IMPORTED_MODULE_0__.newElement)("p", ...Array(2), "Completed Tasks:");
...
const tasks = (task, project, projectKey = "P0", notes, day, time) => {
	...
	const update = function (key, projectName, projectKey, taskName, notes, day, time) {
		...
		datbaseObj && _storage__WEBPACK_IMPORTED_MODULE_1__.pageState.populateStorage(key, newTask);
