...
function displayNewTaskWindow(storageKey = null) {
	...
	if (storageKey) {
		...
		if (_storage__WEBPACK_IMPORTED_MODULE_2__.pageState.getStorage(`${storageKey}`)["day"]) {
			...
			let reFormatArray = _storage__WEBPACK_IMPORTED_MODULE_2__.pageState.getStorage(`${storageKey}`)["day"].split("/");
	...
	form.addEventListener("submit", (e) => {
		...
		if (dateInput && dateRadioNo.checked == false) {
			...
			taskDateValue = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date(year, month, day), "M/d/yyyy");
