...
function home(mainObj) {
	...
	const numberOfTasks = (0,_DOMController__WEBPACK_IMPORTED_MODULE_0__.newElement)("span", "number-of-tasks", `P0-task-count`, mainObj.numberOfTasks);
...
/* harmony import */ var _modules_objectFactory__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/objectFactory */ "./src/modules/objectFactory.js");
...
const instantiateMainProject = (0,_modules_objectFactory__WEBPACK_IMPORTED_MODULE_4__.projects)("All");
let mainListObj = instantiateMainProject.create();

_modules_DOMController__WEBPACK_IMPORTED_MODULE_2__.moduleRender((0,_modules_elementBuilder__WEBPACK_IMPORTED_MODULE_1__.home)(mainListObj), main);
_modules_DOMController__WEBPACK_IMPORTED_MODULE_2__.sendToBody(main);

function recall(selectedProject = null, completed = null) {
	(0,_modules_objectFactory__WEBPACK_IMPORTED_MODULE_4__.projects)().updateShowCompleted(false);
	(0,_modules_objectFactory__WEBPACK_IMPORTED_MODULE_4__.projects)().changeCurrentProject("P0");
	const projectsDiv = document.getElementById("projects-div");
	const taskDiv = document.getElementById("main-task-div");
	...
	for (let i = 0; i < localStorage.length; i++) {
		let storageKey = localStorage.key(i);
		let storageObject = _modules_storage__WEBPACK_IMPORTED_MODULE_3__.pageState.getStorage(storageKey);
