...
/* harmony import */ var _dateTime__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./dateTime */ "./src/modules/dateTime.js");
/* harmony import */ var _taskCountTracking__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./taskCountTracking */ "./src/modules/taskCountTracking.js");
...
function home(mainObj) {
	...
	completedDiv.addEventListener("click", function () {
		showCompleted = (0,_taskHandler__WEBPACK_IMPORTED_MODULE_1__.showHideCompletedTasks)(showCompleted);
	});
...
function dropDownOptionForProjects(storageKey) {
	...
	deleteButton.addEventListener("click", function () {
		...
		(0,_projectHandler__WEBPACK_IMPORTED_MODULE_2__.removeAllTasks)(storageKey);
		(0,_objectFactory__WEBPACK_IMPORTED_MODULE_4__.projects)().deleteProject(storageKey);
...
function newTask(obj) {
	...
	if (day) {
		day = (0,_dateTime__WEBPACK_IMPORTED_MODULE_5__.dateFormatter)(day);
	}
	if (time) {
		time = (0,_dateTime__WEBPACK_IMPORTED_MODULE_5__.timeFormatter)(time);
	}
	...
	newTaskCheckMark.addEventListener("click", function () {
		...
		if (complete) {
			...
			(0,_taskCountTracking__WEBPACK_IMPORTED_MODULE_6__.updateDOMForTotalCompletedTasks)();
			timer1();
		} else {
...
function dropDownOptionForTasks(storageKey) {
	...
	deleteButton.addEventListener("click", function () {
		...
		let projectKey = _storage__WEBPACK_IMPORTED_MODULE_3__.pageState.getStorage(storageKey).projectKey;
		(0,_taskCountTracking__WEBPACK_IMPORTED_MODULE_6__.updateDOMForDeletingTask)(projectKey);
		(0,_objectFactory__WEBPACK_IMPORTED_MODULE_4__.projects)().updateNumberOfTasks(projectKey, "decrement");
		(0,_objectFactory__WEBPACK_IMPORTED_MODULE_4__.tasks)().deleteTask(storageKey);
...
/* harmony import */ var _modules_objectFactory__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/objectFactory */ "./src/modules/objectFactory.js");
...
const instantiateMainProject = (0,_modules_objectFactory__WEBPACK_IMPORTED_MODULE_3__.projects)("All");
